...
para começar o desafio. Declare uma variável chamada `championship` que receberá o nome do campeonato, e imprima o nome desse campeonato no console.
*/
...
desafio.
*/
var times = ['flamengo', 'keyd', 'kabum', 'team one','skt t1'];
...
posicaoTimes(2)
"O time que está em 3º lugar é o Kabum."
posicaoTimes(4)
"O time que está em 5º lugar é o Redemption."
posicaoTimes(10)
"Não temos a informação do time que está nessa posição."
