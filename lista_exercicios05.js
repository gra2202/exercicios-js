...
*/
console.log ("O livro 2 tem " + book('livro2').quatidadePaginas + " páginas!")
'O livro 2 tem 300 páginas!'
...
'O livro livro1 foi publicado pela editora Magika'